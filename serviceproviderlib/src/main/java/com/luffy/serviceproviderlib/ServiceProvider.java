package com.luffy.serviceproviderlib;
        ...
        for (String metaDataKey : keySet) {
            ...
            try {
                ...
                if (!clz.isAssignableFrom(service.getClass())) {
                    throw new IllegalArgumentException(service.getClass().getName() + " you registered as \"" + metaDataValue + "\"" + " is not an instance of " + clz.getName());
                }
